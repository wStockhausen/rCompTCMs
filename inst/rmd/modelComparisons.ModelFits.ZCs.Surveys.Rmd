...
```{r plotFits.SurveyZCsBubblePlotsM,results='asis',fig.height=6.5,fig.width=9.0,out.width="9in",fig.cap=captions,eval.after="fig.cap",fig.pos="H"}
  # mdfr<-rCompTCMs::extractFits.ZScores.PrNatZ(Models,
  #                                             fleet.type="survey",
  #                                             catch.type="index",
  #                                             residuals.type='pearsons',
...
```{r plotFits.SurveyZCsBubblePlotsF,results='asis',fig.height=6.5,fig.width=9.0,out.width="9in",fig.cap=captions,eval.after="fig.cap",fig.pos="H"}
