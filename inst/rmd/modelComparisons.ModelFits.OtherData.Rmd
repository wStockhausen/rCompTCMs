...
```{r plotFits.GrowthData,echo=TRUE,results='asis',fig.height=7.5,fig.width=6.5,out.width="6.5in",fig.cap=captions,eval.after="fig.cap",fig.pos="H"}
...
```{r plotFits.MaturityData,echo=TRUE,results='asis',fig.height=7.5,fig.width=6.5,out.width="6.5in",fig.cap=captions,eval.after="fig.cap",fig.pos="H"}
  message("plotting maturity ogives\n\n")
  captions<-NULL;
  cat("params$minSizeForMaturityData = ",params$minSizeForMaturityData,"\n \n");
