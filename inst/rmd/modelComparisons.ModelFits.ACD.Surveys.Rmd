...
params: 
    Models: none
    title: 'Tanner Crab Assessment Model:/nFits to Aggregated Survey Catch Data' 
    plot1stObs: TRUE
    numRecent: 30
    doc_type: "pdf"
output: 
