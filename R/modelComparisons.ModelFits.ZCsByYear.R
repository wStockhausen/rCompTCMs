#'
#' @title Render a document of comparison plots for model fits to size composition data by year
#'
#' @description Function to render a document of comparison plots for model fits to
#' size composition data by year.
#'
...
#'
#' @details Resulting document title will be of the form "ModelComparisons.ModelFits.ZCsByYear.mmm.ext",
#' where "ext" is the appropriate file extension and "mmm" is a dash-separated string of model names.
#'
#' @export
#'
modelComparisons.ModelFits.ZCsByYear<-function(models,
                                                plot1stObs=TRUE,
                                                output_format=c("word_document","pdf_document"),
                                                output_dir=getwd(),
                                                rmd=system.file("rmd/modelComparisons.ModelFits.ZCsByYear.Rmd",package="rCompTCMs"),
