#'
#' @title Render a document of comparison plots for model fits to survey size composition data by year
#'
...
#' @param rmd - Rmd file to process (defalut="rmd/modelComparisons.ModelFits.ZCsByYear.Surveys.Rmd")
