#'
#' @title Render a document of comparison plots for model fits to 'other' data
#'
...
#'
#' @details Resulting document title will be of the form "ModelComparisons.ModelFits.OtherData.mmm.ext",
#' where "ext" is the appropriate file extension and "mmm" is a dash-separated string of model names.
#'
#' @export
#'
modelComparisons.ModelFits.OtherData<-function(models,
                                                plot1stObs=TRUE,
                                                output_format=c("word_document","pdf_document"),
                                                output_dir=getwd(),
                                                rmd=system.file("rmd/modelComparisons.ModelFits.OtherData.Rmd",package="rCompTCMs"),
  ...
  output_file<-paste0("ModelComparisons.ModelFits.OtherData.",mmm,".",ext);
  title<-paste0("Model Comparisons for Fits to Other Data\n",mmv);
