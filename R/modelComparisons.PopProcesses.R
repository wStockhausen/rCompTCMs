...
#' @export
#'
modelComparisons.PopProcesses<-function(models,
                                         output_format=c("word_document","pdf_document"),
                                         output_dir=getwd(),
                                         rmd=system.file("rmd/modelComparisons.PopProcesses.Rmd",package="rCompTCMs"),
  ...
  output_file<-paste0("ModelComparisons.PopProcesses.",mmm,".",ext);
  title<-paste0("Model Comparisons: Population Processes -- ",mmv);
