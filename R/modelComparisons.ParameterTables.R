#'
#' @title Render a document of parameter tables for model comparisons
#'
#' @description Function to render a document of parameter tables for model comparisons.
#'
...
#' @param rmd - Rmd file to process (defalut="modelComparisons.ParameterTables.Rmd")
...
#'
#' @details Resulting document title will be of the form "ModelComparisons.ParameterTables.mmm.ext", where "ext" is the appropriate
#' file extension and "mmm" is a dash-separated string of model names.
#'
#' @export
#'
modelComparisons.ParameterTables<-function(models,
                            output_format=c("word_document","pdf_document"),
                            output_dir=getwd(),
                            rmd=system.file("rmd/modelComparisons.ParameterTables.Rmd",package="rCompTCMs"),
  ...
  output_file<-paste0("ModelComparisons.ParameterTables.",mmm,".",ext);
  title<-paste0("Model Comparisons: Parameter Tables -- ",mmv);
